...
import pl.edu.mimuw.forum.ui.change.AuthorChange;
import pl.edu.mimuw.forum.ui.change.ContentChange;
...
public class NodeViewModel {
	...
	protected ChangesHistory undoRedoBuffer;
	...
	public NodeViewModel(Node node) {
		...
		getAuthor().addListener((observable, oldValue, newValue) -> {
			undoRedoBuffer.registerChange(new AuthorChange(this, oldValue, newValue));
		});
		
		getContent().addListener((observable, oldValue, newValue) -> {
			undoRedoBuffer.registerChange(new ContentChange(this, oldValue, newValue));
		});
	}
	
	public void setUndoRedoBuffer(ChangesHistory undoRedoBuffer) {
