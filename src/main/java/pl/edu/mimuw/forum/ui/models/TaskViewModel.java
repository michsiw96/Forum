...
public class TaskViewModel extends NodeViewModel {
	...
	public TaskViewModel(Task task) {
		...
		getDueDate().addListener((observable, oldValue, newValue) -> {
			System.out.println("Changing date: " + oldValue + "->" + newValue);
			undoRedoBuffer.registerChange(new DateChange(this, oldValue, newValue));
		});
	}
